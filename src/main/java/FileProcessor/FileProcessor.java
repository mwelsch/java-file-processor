...
public interface FileProcessor {
     ...
     */
    public default Map<String, Object> read(String filePath) throws IOException, InvalidFileContent;
     ...
     */
    public default void write(String filePath, Map<String, Object> data) throws IOException;
}
